...
DOMOTICA = [
    ...
    item("cómo está la temperatura del cuarto del bebé ahora mismo"),
    ...
    item("apaga la luz de la cocina y deja encendida la del pasillo"),
    ...
    item("desarma la alarma de la entrada antes de abrir la puerta"),
    item("está abierta la ventana del balcón"),
    item("quiero la sala más fresca sin apagar el ventilador", amb=True),
    item("deja el dormitorio a oscuras pero con luz tenue"),
    item("enciende la luz del baño pequeño junto a la cocina"),
    item("cuando me vaya apaga todo lo que quede prendido", amb=True),
    item("pon las luces del comedor en cálido al treinta por ciento"),
    item("sube un poco más la intensidad de la lámpara del escritorio"),
    ...
    item("habre la persiana del cuarto", noise=True),
    ...
    item("baja todas las persianas del frente menos la del despacho de arriba"),
    item("prende las luces del jardín y avísame si se detecta movimiento afuera"),
    ...
    item("desbloquea la cerradura de la entrada para que pase mi hermano"),
    item("bloquea la puerta principal y confirma si quedó bien cerrada"),
    ...
    item("quiero la casa lista para dormir con todo apagado salvo el pasillo", amb=True),
    ...
    item("qué marca el sensor de humo de la cocina ahora mismo"),
...
MUSICA = [
    ...
    item("ponme boleros viejitos para cenar tranquilos sin tanta tristeza"),
    item("reproduce la lista domingo tranquilo que tengo guardada en Spotify"),
    item("abre Spotify y pon mi descubrimiento semanal en el altavoz del salón"),
    item("quiero escuchar el último disco de Karol G completo desde el principio"),
    item("pon música para limpiar la casa a buen volumen pero no reguetón"),
    item("sáltate esta y busca otra parecida"),
    item("busca versiones acústicas de Juan Luis Guerra para esta tarde"),
    item("pon algo parecido a lo que suena ahora pero más suave", amb=True),
    ...
    item("quita esa cansion", noise=True),
    ...
    item("pon una lista para cenar con amigos que no sea muy intensa ni triste"),
    item("quiero música instrumental para leer sin letra ni sobresaltos esta noche"),
    item("sigue con algo parecido pero un poco más alegre que esto", amb=True),
    item("pon salsa de los noventa y luego algo de bachata suave"),
    item("ponme el tema que dice despacito pero no el remix"),
    item("no esa no, la versión en vivo que suena más limpia"),
    item("mezcla flamenco con pop español a ver qué sale hoy"),
    item("deja sonando música hasta que me duerma y luego bájala sola"),
    ...
    item("reproduce en todos los parlantes menos en el cuarto del bebé"),
    item("quita el modo aleatorio y sigue el álbum desde la tercera"),
    ...
    item("para la rola"),
    item("quiero un tema de despecho para cantar en la cocina"),
    item("pon electrónica suave que no tenga drops bruscos porque estoy trabajando"),
    item("arranca con una versión en directo de Sabina y luego sigue parecido"),
    item("busca una playlist de reggaetón viejo para la fiesta del sábado"),
]
...
GENERAL = [
    ...
    item("agenda una alarma para las seis de la mañana"),
    ...
    item("necesito ideas para cenar rápido con lo que tengo en la nevera"),
    item("recomiéndame una serie para ver esta noche que no sea muy larga"),
    item("si salgo ahora necesito paraguas o mejor me llevo chaqueta"),
    item("cuánto tardaría en llegar al aeropuerto un viernes por la tarde"),
    item("explícame por qué el cielo cambia de color al atardecer"),
    item("acuérdame sacar la basura mañana después del desayuno sin falta"),
    item("dame tres opciones de desayuno con huevo y aguacate para mañana"),
    item("cuéntame algo interesante de Surinam que no sepa casi nadie"),
    item("cómo va el dólar hoy y si subió respecto a ayer"),
    item("cuánta batería le queda al móvil"),
    item("busca dónde queda la farmacia de guardia más cercana abierta ahora"),
    item("ke ora es", noise=True),
    item("cuanto e 17 por 23", noise=True),
    item("va a yobé mañana", noise=True),
    item("esplicame que es la fotosintesis", noise=True),
    item("cuentame un chiste malo", noise=True),
    ...
    item("qué pasó hoy en el país y si afecta algo para mañana"),
    item("estaba pensando si mañana hará calor porque tengo que salir temprano"),
    item("necesito que me expliques como si tuviera diez años qué es la inflación"),
    ...
    item("cuál es la diferencia entre un asteroide, un meteoro y un meteorito"),
    item("hoy me siento raro, qué puedo hacer para relajarme un poco"),
    item("si viajo a Madrid el mes que viene, qué ropa me conviene llevar"),
    item("oye tengo sueño pero todavía me falta trabajar, algún consejo"),
    ...
    item("quiero saber si mañana necesito abrigo para salir con los niños temprano"),
    item("explícame por qué el pan se pone duro cuando lo dejo afuera toda la noche"),
    item("si tengo que hacer una tortilla para seis personas, cuántos huevos uso"),
